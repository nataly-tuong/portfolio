...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute z-20 left-0 right-0 bottom-0 h-20 sm:h-32 md:h-40 bg-gradient-to-t from-black to-transparent pointer-events-none" />
      <a
        href="#About"
      ...
      >
        <svg
          className="scroll-arrow w-10 h-10 text-red-500 text-glow-red"
          fill="none"
          stroke="currentColor"
          strokeWidth="2.6"
          viewBox="0 0 24 24"
