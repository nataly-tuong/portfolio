      ...
      <div className="bg-black w-full h-100 relative text-white px-15 py-20">
        ...
        <div className="relative overflow-hidden whitespace-nowrap mb-6">
          <div ref={headersRef} className="flex gap-x-5 inline-flex">
            <h3 className="skills-header skills-style">SKILLS</h3>
            <h3 className="skills-header skills-style">+</h3>
            <h3 className="skills-header skills-style">LIBRARIES</h3>
            <h3 className="skills-header skills-style">+</h3>
            <h3 className="skills-header skills-style">TOOLS</h3>
            <h3 className="skills-header skills-style">+</h3>
            <h3 className="skills-header skills-style">FRAMEWORKS</h3>
            <h3 className="skills-header skills-style">+</h3>
            <h3 className="skills-header skills-style">LANGUAGES</h3>
            <h3 className="skills-header skills-style">+</h3>
            <h3 className="skills-header skills-style">SKILLS</h3>
            <h3 className="skills-header skills-style">+</h3>
            <h3 className="skills-header skills-style">LIBRARIES</h3>
